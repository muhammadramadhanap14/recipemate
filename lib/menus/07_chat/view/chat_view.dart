...
class _ChatViewState extends State<ChatView> {
              ...
              children: [
                ...
                Obx(() {
                  ...
                  bool isActiveTimer =
                      ...
                      msg.stepIndex != null &&
                      controller.activeTimerStepIndex.value == msg.stepIndex;
  ...
  Widget _buildTimerCard(
    ...
    final seconds = isActive
        ...
        : controller.stepRemainingSeconds[stepIndex] ??
              controller.extractTimeInSeconds(step);
              ...
              children: [
                Expanded(
                  child: customRawMaterialButton(
                    onPressed: () => controller.toggleTimerFromStep(stepIndex),
                ...
                Expanded(
                  child: customOutlinedButton(
                    onPressed: () => controller.updateTimerForStep(stepIndex),
  ...
  Widget _buildInputField(BuildContext context) {
    ...
    return Obx(
      () => AbsorbPointer(
        absorbing: controller.isCooking.value,
        child: Container(
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: TextField(
                    ...
                    enabled: !controller.isCooking.value,
                    readOnly: controller.isCooking.value,
                    style: TextStyle(
                      color: colorScheme.onSurface,
                      fontSize: DimensText.bodyText(context),
                      fontFamily: 'Poppins-Regular',
                    ...
                    decoration: InputDecoration(
                      hintText: controller.isCooking.value
                          ? "Memasak... chat dinonaktifkan"
                          : "Type a message...",
                      hintStyle: TextStyle(
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: controller.isCooking.value
